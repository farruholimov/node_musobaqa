...
const AdminInlineKeyboards = {

        choose_menu: new InlineKeyboard()
            .text("Xizmatlar", "sections")
            .text("Ustalar", "masters")
            .row()
            .text("Mijozlar", "clients"),
...
export default AdminInlineKeyboards;